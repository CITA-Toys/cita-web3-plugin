...
class CITA {
    constructor(server) {
        ...
        this.netPeerCount = () => this.citaFetch({
            method: typings_1.METHODS.PEER_COUNT,
            params: [],
        });
        this.getBlockNumber = () => this.citaFetch({
            method: typings_1.METHODS.BLOCK_NUMBER,
            params: [],
        });
        this.sendSignedTransaction = (signedData) => this.citaFetch({
            method: typings_1.METHODS.SEND_RAW_TRANSACTION,
            params: [signedData],
        });
        this.getBlockByHash = ({ hash, txInfo, }) => this.citaFetch({
            method: typings_1.METHODS.GET_BLOCK_BY_HASH,
        ...
        this.getBlockByNumber = ({ quantity, txInfo, }) => this.citaFetch({
            method: typings_1.METHODS.GET_BLOCK_BY_NUMBER,
